 ...
 */
define("marketDetails", ["tpl/marketDetails_tpl", "lib/lazyload", "lib/cookie", "lib/tpl", "lib/zepto", "jxcar"], function (require) {
    var t_pl = require('tpl/marketDetails_tpl');
    ...
    jxcar.ready(function(){
        ...
        var posturl = '//m-api.xcar.com.cn/cms/NewsList/marketDetail';
        ...
        function follow(intention) {
            ...
            return jxcar.requestFollow({
                ...
                if (data && data.result) {
                    ...
                    $('.follow-btn')
                        .attr('class', 'follow-btn ' + foll_Stu[state]['class'])
        ...
        function renderview() {
            ...
            jxcar.onLoadSuccess({
                //isOperateEnable: news.error.errorCode == 1,
        ...
        function imgfilter(str) {
            ...
            if (view.imagemode == 2) {
                img.original = img.src + '-w280.jpg'
            }
            var imghold = "data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='" + img.width + "' height='" + img.height + "' />";
            if (img.src.indexOf('xcar.com.cn') > 0||img.src.indexOf('xcarimg.com')) {
                return '<img src="' + imghold + '" style="width: 100%" class="lazy inimg" data-src="' + img.src + '" data-original="' + img.original + '" />'
        ...
        function changeview(param) {
            ...
            if (view.imagemode) {
                ...
                $('img.lazy:not(.loaded)').each(function () {
                    ...
                    if (view.imagemode == 2)
                        $(this).data('original', _src + '-w280.jpg')
                    else
        ...
        function eventfactory() {
            ...
            root.on('click', '.master .inimg,.master .outimg', function () {
                ...
                .on('click', '.reply .inimg,.master .outimg', function () {
                    var src = $(this).data('src')
                    src && jxcar.requestImages({
                        imageUrl: src
                    })
                })
                /*.on('click', '.check-forum', function () {
                 var _param = {
                 forumId: thread.forumId,
                 forumName: thread.forumName
                 }
                 if (jxcar.requestForum)
                 jxcar.requestForum(_param)
                 .then(function (rs) {
                 console.log(rs);
                 })
                 else
                ...
                .on('click','.note .js-vote-list input[name="vote"]',function (e) {
                    ...
                    var _$num = $(".js-vote-num"),_limit_count = _$num.attr("data-vote-limit-count");
        ...
        $.when(
            ...
            $.extend(share, {
                ...
                content: "点击查看车辆行情",
                imageUrl: rdata.data.imageUrl,
                linkUrl: rdata.data.webLink
            })
            render(t_pl, rdata);
            renderview()
